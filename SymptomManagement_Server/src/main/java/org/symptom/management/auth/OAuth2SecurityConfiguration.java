package org.symptom.management.auth;
		...
		public OAuth2Config() throws Exception {
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							...
							User.create("sdurand", "sdurand", "USER"),		// patient section
							User.create("psmith", "psmith", "USER"),
							User.create("jbeck", "jbeck", "USER"),
							User.create("mdupond", "mdupond", "USER"),
							User.create("jjacques", "jjacques", "USER"),
							User.create("mtelo", "mtelo", "USER"),
							User.create("tpumba", "tpumba", "USER"),
							User.create("doc1", "doc1", "USER"),	//doctor section
							User.create("doc3", "doc3", "USER"),
							User.create("doc4", "doc4", "USER"),
							User.create("doc2", "doc2", "USER")));
